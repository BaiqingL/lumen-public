...
Issued by **Baiqing Lyu (Lumen)**. Original operative permission approved and issued September 8, 2026; candidate6 technical release association updated **September 11, 2026**, following the publisher's approval. The recipient permission and covered material scope below are unchanged.

## Covered release

- Application: Lumen `0.1.0`, build `1000000`, bundle `com.lumen.mediaplayer`; candidate6.
- Native implementation: `d626e534e97efbb0c9771396fdbc40b5d81d6971`.
- Native library: `liblumencapabilities.so`, ARM64, 676,744 bytes.
- Native library SHA-256: `d5dd5d01006e570faa90463763bcf7abce513dd6791ec955c0861f7c08942601`.
- Version-specific kit: `lumen-0.1.0-1000000-candidate6-native-relink-d5dd5d01.zip`.
- Source and relink download page: https://lumenapp.tv/source.html
- Release record and detached checksum: https://github.com/BaiqingL/lumen-public/releases/tag/native-relink-v0.1.0-1000000-candidate6
- Candidate6 permission metadata: https://lumenapp.tv/relink-permission-0.1.0-1000000-candidate6.md

The kit's `manifest.json` identifies the supplied files and their SHA-256 hashes. The release record supplies the checksum of the complete archive. These identifiers associate this permission with the supplied original materials; they do not expand its scope. Historical kits and release associations remain separate.
